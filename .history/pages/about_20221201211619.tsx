  ...
  return (
    <>
      ...
      <Layout title="About - For Them">
        <div className="webflow-content-wrapper" dangerouslySetInnerHTML={{ __html: props.bodyContent }} />
      </Layout>
    </>
  );
};
...
export async function getStaticProps(ctx) {
  ...
  // const bodyContent = $(`body > div:not(.w-nav)`).html();
  const bodyContent = $(`div:not(.navigation) + `).html();
  console.log(bodyContent, "Body Content From Business");

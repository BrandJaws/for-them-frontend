          ...
          <div className="grid xl:grid-cols-1 lg:grid-cols-1 md:grid-cols-1 sm:grid-cols-1 xs:grid-cols-1 gap-4">
            <div className="flex gap-4 flex-col flex-wrap justify-center items-center">
              ...
              <div className="grid xl:grid-cols-12 lg:grid-cols-8 md:grid-cols-2 sm:grid-cols-1 xs:grid-cols-1 gap-[30px] lg:section-padding xl:section-padding w-full">
                ...
                <div className="text-box xl:col-span-2 lg:col-span-2 p-5 border rounded-md border-black text-center w-full flex items-center justify-center">
                  <Fade>
                    <p className="max-w-[112px] max-h-[76px]">I&apos;m new to binding + not sure where to start</p>
                  </Fade>
                </div>
                <div className="text-box xl:col-span-2 lg:col-span-2 p-5 border rounded-md border-black text-center w-full">
                  <Fade>
                  <p className="max-w-[112px] max-h-[76px]">None of the binders out there are doing it for me</p>
                  </Fade>
                </div>
                <div className="text-box xl:col-span-2 lg:col-span-2 p-5 border rounded-md border-black text-center w-full">
                  <Fade>
                    <p className="max-w-[112px] max-h-[76px]">

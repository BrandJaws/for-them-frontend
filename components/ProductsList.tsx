...
export const Product = ({ product, goToProductPage }) => {
  ...
  return (
    <>
      <Fade bottom>
        <div
          className="p-4 cursor-pointer text-center flex flex-col items-center justify-between xl:gap-[40px] lg:gap-[42px] md:gap-[34px] sm:gap-[26px] xs:gap-[26px] xl:mb-[50px] lg:mb-[42px] md:mb-[34px] sm:mb-[26px] xs:mb-[26px]"
        ...
        >
          ...
          <div className="subtitle-bold text-center lightFont">Shop</div>
